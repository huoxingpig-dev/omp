package com.gis.omp.common.auth.constant;

public class AuthConstant {

    public static final String COOKIE_NAME = "omp-gateway";

    // header set for internal user id
    public static final String CURRENT_USER_HEADER = "omp-current-user-id";
